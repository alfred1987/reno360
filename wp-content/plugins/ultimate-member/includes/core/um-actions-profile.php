...
function um_profile_header( $args ) {
	...
	<div class="um-header<?php echo $classes; ?>">
		...
		<div class="um-profile-meta">
            ...
            <style type="text/css">
            	p { font-weight: normal; color: #000; font-size: 20px; }
            	.renobig { font-size: 40px; }
            	.pi_ul { list-style: none; padding: 0; margin: 0; }
            	.pi_ul li {display: inline-block; padding: 0px 15px 0px 10px;}
            	.renobutton {
					padding: 10px 25px;
					background: #999999;
					color: #000;
				...
				<?php if ( $args['show_name'] ) { ?>
					<div class="um-name">
						...
						<a href="<?php echo um_user_profile_url(); ?>"
						   title="<?php echo um_user( 'display_name' ); ?>"><h3><strong><?php echo um_user( 'display_name', 'html' ); ?></strong></h3></a>

						<p>House Owner of <span class="renobig">Southville Executive Suite</span></p>
						<p>Property Profile created : 5/5/2018<br />Current house renovation status : <strong>Planning stage</strong></p>

						<ul class="pi_ul">Property Information: 
							<li>3D</li>
							<li>360</li>
							<li>Plan</li>
						</ul>
	...
	<style type="text/css">
		...
		.iconsbudget li { display: inline-block; padding-right: 25px; }
	</style>
	<div style="margin-top: 50px;">
		<h3><strong>Start your planning with layout design</strong></h3>
		<div><p><img src="<?php echo get_template_directory_uri(); ?>/assets/images/reno/optiona.jpeg" /></p></div>
		<div>Option A<br />Suitable for : Young couple<br />Concept : Open and maximize space</div>
		<div>
			<textarea rows="4" cols="50"></textarea><br />
			<a class="renobutton" href="#">Use this</a>
		</div>

		<hr style="margin-top: 50px;margin-bottom: 50px;" />

		<h3><strong>Choose your preferences styles</strong></h3>
		<div><p><img src="<?php echo get_template_directory_uri(); ?>/assets/images/reno/modern.jpg" /></p></div>
		<div>Modern</div>
		<div>
			<textarea rows="4" cols="50"></textarea><br />
			<a class="renobutton" href="#">Use this</a>
		...
		<p><strong>Allocate your budget</strong><br />Suggestion by system: Total required RM65,000.00</p>
		<p><img src="<?php echo get_template_directory_uri(); ?>/assets/images/reno/icons.png" /></p>
		<ul class="iconsbudget">
			<li>Construction works<br /><input type="text" /></li>
			<li>Furniture<br /><input type="text" /></li>
			<li>Lighting<br /><input type="text" /></li>
			<li>Electrical appliances<br /><input type="text" /></li>
		</ul>
		<br />
		<span class="get_started renobutton" style="cursor: pointer;">Get started</span>
	</div>
