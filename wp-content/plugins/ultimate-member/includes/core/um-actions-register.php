...
function um_add_submit_button_to_register( $args ) {
	...
	<div class="um-col-alt">
		...
		<?php if ( isset($args['secondary_btn']) && $args['secondary_btn'] != 0 ) { ?>
			...
			<div class="um-left um-half"><input type="submit" value="Register for FREE" class="um-button" id="um-submit-btn" /></div>
			<!--NINJA <div class="um-left um-half"><input type="submit" value="<?php echo __( $primary_btn_word,'ultimate-member'); ?>" class="um-button" id="um-submit-btn" /></div>-->
			<!--NINJA <div class="um-right um-half"><a href="<?php echo $secondary_btn_url; ?>" class="um-button um-alt"><?php echo __( $secondary_btn_word,'ultimate-member'); ?></a></div>-->
